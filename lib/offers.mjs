...
/**
 * Returns true if this email already has a reserved or issued code for the
 * SAME offer (same offer_id). Prevents double-claim within a single offer
 * window (e.g. user reloads + resubmits, or claims again before redeeming).
 */
export async function hasUnredeemedCodeForOffer(email, offerId) {
