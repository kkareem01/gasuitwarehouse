...
/**
 * Staff dashboard auth: Bearer STAFF_TOKEN, constant-time compare. Used by
 * every /api/admin/* handler that touches customer PII (here and in
 * lib/handlers-sales.mjs). The aggregate stats endpoints (funnel-stats,
 * revenue-stats, ad-spend, ad-spend-set) are deliberately unguarded so the
 * owner can open the stats page without a token.
 */
