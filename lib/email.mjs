...
export function intakeReadyForPickupEmail({ intake, businessName, businessAddress, businessPhone }) {
  ...
  const subject = `Your tailoring is ready for pickup — ${businessName}`;
  ...
  const html =
    WRAPPER_OPEN +
    `
    <h1 style="font-family:Georgia,serif;font-size:24px;font-weight:600;color:#14213D;margin:0 0 16px 0;">Your tailoring is ready, ${safeFirst}.</h1>
    <p style="margin:0 0 20px 0;font-size:16px;">Good news — the work you brought in is back from our tailor and ready for pickup whenever you're in the area.</p>
  ...
  const text =
    `Your tailoring is ready, ${intake.firstName || 'there'}.\n\n` +
    `The work you brought in is back from our tailor and ready for pickup.\n\n` +
